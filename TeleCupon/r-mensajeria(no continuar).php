...
<body>
    ...
    ?>
    <!-- Start-->
    <div class="que-estas-buscando-header" style="background: #FFCB21;">
        <div class="container">
            <div class="row">
                <div class="col-12">
            ...
            <div class="que-estas-buscando-header-white-table">
                <div class="row">
                    <table style="width:100%;" class="text-center que-estas-buscando-header-white-table">
                        ...
                        <th class="last-white-mensajeria">MENSAJERÍA</th>
                    </table>
                </div>
            </div>
            ...
            <div class="col-4">
                <div class="fast-food">
                    <a href="subcategory/fastfood" <button type="button" class="selective-button1" alt="FastFood">
                        <img src="images/Local.png" class="img-fluid fast-food-img  d-block d-sm-none">
                        <img src="images/Local-large.png" class="img-fluid fast-food-img d-none d-sm-block">
            ...
            <div class="col-4">
                <div class="fast-food">
                    <a href="subcategory/gourmet" <button type="button" class="selective-button1" alt="Gourmet">
                        <img src="images/Nacional.png" class="img-fluid fast-food-img  d-block d-sm-none">
                        <img src="images/Nacional-large.png" class="img-fluid fast-food-img d-none d-sm-block">
                        <p class="text-center p-selective-buttons">
                            Nacional
                        </p>
                        </button>
            ...
            <div class="col-4">
                <div class="fast-food">
                    <a href="subcategory/tradicional" <button type="button" class="selective-button1" alt="Tradicional">
                        <img src="images/Internacional.png" class="img-fluid fast-food-img  d-block d-sm-none">
                        <img src="images/Internacional-large.png" class="img-fluid fast-food-img d-none d-sm-block">
                        <p class="text-center p-selective-buttons">
                            Internacional
                        </p>
                        </button>
