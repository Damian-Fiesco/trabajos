        ...
        <div class="row">
            <div class="text-justify col-12">
                <p class="p-proceso-cupon">
                    ...
                    <br>
                    <br>
                    Una vez que hayas creado tu cuenta podrás elegir entre nuestras distintas categorías de productos y servicios en tu localidad para encontrar lo que estás buscando.
                    <br>
                    <br>
                    Cuando hayas elegido, <b>descarga tu cupón, puedes hacerlo válido de distintas maneras, enviando un SMS con el código correspondiente a la promoción, escaneando con la cámara de tu teléfono el código QR que descargará directamente el cupón en tu móvil o puedes llamar al negocio y mencionar el código de la promoción que deseas validar.</b>
                </p>
            </div>
        </div>
