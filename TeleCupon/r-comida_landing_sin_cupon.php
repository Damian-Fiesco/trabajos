...
<head>
    ...
    ?>
    <title>Comida tradicional - Sin Cupón</title>
</head>
...
<body>
    ...
    <div class="container">
        ...
        <div class="upper-half-comida-landing">
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="tienda-landing-banner">
                        <img src="images/A89A9370 1.png" class="img-fluid tienda-landing-banner-img">
                        <div class="  row">
                            <div class="redes position float-left">
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    <button type="button" class="float-end instagram">
                                        <img src="images/instagram.png" class="img-fluid instagram-img">
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="tienda-landing-name-plate">
                                <p class="p1-tienda-landing-name-plate">
                                    Pasillo de Humo
                                </p>
                                <p class="p2-tienda-landing-name-plate">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="tienda-landing-buttons">
                        ...
                        <div class="row lower-two">
                            ...
                            <div class="col-6">
                                <button type="button" class="text-center button-8-9-10-11">
                                    <div clasS="row">
                                        <div class="col-6">
                                            <img src="images/Telefono-button.png" alt="Al escanear con tu móvil automáticamente se descargará tu cupón." class="img-fluid button-31-img">
                                        </div>
                                        <div class="col-6">
                                            <p class="text-left p-button-31">
                                                ¡Llamanos!
                                            </p>
                                        </div>
                                    </div>
        ...
        <div class="row">
            <div class="text-center col-12 col-md-6">
                <p class="text-center cuponera">
                    Cuponera
                </p>
                <div class="row d-block d-md-none">
                    <div class="col-12">
                        <img src="images/no-cupon.png" class="img-fluid" alt="no-hay-cupones">
                    </div>
                </div>
                <div class="row d-none d-md-block">
                    <div class="big-no-cupon">
                        <div class="float-start col-3">
                            <img src="images/sad 1.png" class="img-fluid big-no-cupon-img" alt="cupon-img">
                        </div>
                        <div class="float-end col-9">
                            <p class="p-big-no-cupon">
                                <b>Lamentablemente este cupón no está disponible </b>en tu zona, pero no te desanimes, tenemos grandes descuentos cerca de ti, da clic para conocerlos.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <!--<div class="row">-->
            <div class="col-12 col-md-6">
                <div class="d-none d-md-block mapa-tienda-landing">
                    <div class="nuestra-ubicacion">
                        <p class="p-nuestra-ubicacion">
                            Nuestra ubicación.
                        </p>
                    </div>
                </div>
