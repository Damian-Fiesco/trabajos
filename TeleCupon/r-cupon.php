...
<body>
    <!-- Start-->
    <div class="container">
        <div class="text-center r-huge-cupon">
            <div class="col-12">
                <img src="images/tele-logo-cupon2.png" class="r-huge-cupon-img">
                <div class=" text-center r-huge-cupon-grey">
                    <div class="text-center r-huge-cupon-upper-half">
                        <div class="row">
                            <div class="col-12">
                                <p class="p1-huge-cupon-grey">
                                    Cupón valido por
                                </p>
                                <p class="p2-huge-cupon-grey">
                                    UNA BEBIDA GRATIS
                                </p>
                                <p class="p3-huge-cupon">
                                    A partir de $25 usd de<br>consumo.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="text-center huge-cupon-lower-half-grey">
                        <div class="row">
                            <div class="col-12">
                                <p class="p4-huge-cupon">
                                    Cortesía de
                                </p>
                                <p class="p5-huge-cupon">
                                    Pasillo de Humo
                                </p>
                            </div>
                        </div>
                        <div class="huge-cupon-buttons">
                                ...
                                <div class="col-6">
                                    <button type="button" class="float-end text-center button-27-28-29-30-huge-cupon" style="margin-right:-15px;">
                                        <div clasS="row">
                                            ...
                                            <div class="col-6">
                                                <p class="text-left p-button-27-28-29-huge-cupon">
                                ...
                                <div class="col-6">
                                    <button type="button" class="text-center button-27-28-29-30-huge-cupon" style="margin-right:-15px;">
                                        <div clasS="row">
                                            ...
                                            <div class="col-6">
                                                <p class="text-left p-button-30-huge-cupon">
                                                    ¡Llamanos!
                                                </p>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="QR-code-huge-cupon">
                                <img src="images/QR-code.png" class="Qr-code-huge-cupon-img-grey">
                            </div>
                        </div>
                    </div>
                    <div class="row">
